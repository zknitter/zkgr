...
#' inspection.
#'
#' **NOTE:** These functions and associated documentation were adapted from
...
#' behavior of `fs::path_package()` in fs v1.2.7.9001 and higher.*
#'
